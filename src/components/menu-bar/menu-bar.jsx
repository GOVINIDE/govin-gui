...
class MenuBar extends React.Component {
    ...
    handleDownloadFirmware() {
        if (window.confirm("Click OK if You want to Upload the firmware?")) {
            if (this.props.deviceId) {
            ...
            console.log("Firmware Upload cancelled.");
        }
    }
    handleScreenshot() {
        const blocks = document.querySelector('.blocklyWorkspace .blocklyBlockCanvas');
    ...
    handleCheckUpdate() {
        ...
        // const githubUrl = 'https://raw.githubusercontent.com/pranjalinaik5/my-json-files/main/file.json';
        ...
        return (
            ...
            >
                <div className={styles.mainMenu}>
                    ...
                    CARES Test */}
                    <div
                        className={classNames(styles.menuBarItem, styles.hoverable)} //cares 2.0.7
                        //    className={classNames(styles.menuBarItem, this.props.isRealtimeMode ? styles.hoverable : styles.disabled)}
                        // onMouseUp={this.props.isRealtimeMode ?
                        //     this.handleDownloadFirmware : null}
                        onMouseUp={
                            this.handleDownloadFirmware} //cares 2.0.7
                    >
                        <img
                            alt="UploadFirmware"
