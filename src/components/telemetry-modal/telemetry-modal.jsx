...
const messages = defineMessages({
    ...
    bodyText1: {
        defaultMessage: 'The PMU CARES Team is always looking to better understand how GoVIN is used around the ' +
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the PMU CARES privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the PMU CARES Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the PMU CARES Team',
        description: 'Text for telemetry modal opt-in button',
