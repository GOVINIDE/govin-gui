...
{/* <Tab
                    className={tabClassNames.tab}
                    onClick={handleActivateArduinoTab} // Updated function
                >
                    <img draggable={false} src={progIcon} />
                    <FormattedMessage
                        defaultMessage="Text Programming"
                        description="Button to get to the Text Programming panel"
                        id="gui.gui.arduinoTab"
                ...
                <Tab
                    className={tabClassNames.tab}
                    onClick={handleActivatePythonTab} // Updated function
                >
                    <img draggable={false} src={pythonIcon} />
                    <FormattedMessage
                        defaultMessage="Python"
                        description="Button to get to the Python panel"
                        id="gui.gui.pythonTab"
